...
class WidgetDropdwonEdite extends StatelessWidget {
  ...
  WidgetDropdwonEdite({
    ...
    this.initialSelectedOptions, // Initialize the new parameter
  });
    ...
    return Column(
      ...
      children: [
        ...
        FormField<List<ValueItem<dynamic>>>(
          initialValue: initialSelectedOptions, // Set initial value
          validator: validator,
