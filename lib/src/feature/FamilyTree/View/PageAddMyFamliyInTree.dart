...
class PageAddMyFamliyInTree extends StatefulWidget {
  String tree;

  PageAddMyFamliyInTree({super.key,required this.tree});
  @override
  _PageAddMyFamliyInTreeState createState() => _PageAddMyFamliyInTreeState();
}

double _scale = 1.0;
double _previousScale = 1.0;

class _PageAddMyFamliyInTreeState extends State<PageAddMyFamliyInTree> {
  ...
  void searchNode(String query) {
    setState(() {
      ...
      graph.nodes.forEach((node) {
        ...
        if (member['id'] == query || member['name'] == query) {
